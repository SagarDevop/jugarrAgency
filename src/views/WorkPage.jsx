    ...
    <div className="pt-28 sm:pt-36 pb-20 px-4 sm:px-8 max-w-7xl mx-auto">
      ...
      <div className="max-w-4xl space-y-4 mb-12">
        <div className="inline-flex items-center gap-2 font-mono text-xs text-accent font-bold tracking-widest uppercase">
          <span>[ PORTFOLIO ARCHIVE // REAL WORK ]</span>
        </div>
        ...
        <p className="text-base sm:text-xl text-charcoal-600 max-w-2xl font-normal leading-relaxed pt-2">
          Explore real client projects and demonstrable web applications built by Sagar. Every project represents genuine code, verifiable interfaces, and practical execution.
        </p>
      </div>
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 items-start">
